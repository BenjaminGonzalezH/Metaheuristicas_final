...
Path_Params = 'Results/Parameters/Parte2_P/best_HGAc1_ini_params.txt'
Path_OPT = "Optimals/Experimental/Optimals.txt"
output_directory = 'Results/Experimentals/Parte2_P'
...
results_file_path = os.path.join(output_directory, 'HGAc1_ini_converge_38.csv')
...
b, result = GAc_Hybrid_1(best_params['POP_SIZE'], 
                            Instances[0], 
                            len(Instances[0]),
                            80000,
                            best_params['T_SIZE'],
